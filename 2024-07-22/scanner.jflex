...
token_1   = "A:"({hex}|"abc")({tok1_symb}{tok1_symb}{tok1_symb} | {tok1_symb}{tok1_symb}{tok1_symb}{tok1_symb}{tok1_symb})([A-Z]([A-Z][A-Z])*)

tok2_char = "cd"|"ef"|"gh"|"ij"
tok2_symb = "&" | "?" | "!"
tok2_word = ({tok2_char}{tok2_char}{tok2_char}) | ({tok2_char}{tok2_char}{tok2_char}{tok2_char}{tok2_char}{tok2_char}) 

token_2   = "B:"({tok2_word}{tok2_symb}{tok2_word}{tok2_symb}{tok2_word})({tok2_symb}{tok2_word})*

year = 2024
date = "13-April-2024" |
        (1[3-9] | 2[0-9] | 30 ) "-" ("April") "-" {year} | 
        ((0[1-9]) | [1-2][0-9] | 30 | 31) "-"  ("May")  "-" {year} |
        ((0[1-9]) | [1-2][0-9] | 30 ) "-" ("June") "-" {year} | 
        ((0[1-9]) | [1-2][0-9] | 30 | 31)  "-"  ("July")  "-"  {year} | 
        ((0[1-9]) | [1-2][0-9] | 30 | 31)  "-"  ("August") "-" {year} | 
        (0[1-9]) "-"  ("September")  "-"  {year} |
       "19-September-2024"
time = "10:07" |
       "10:"0[7-9] | 
       "10:"[1-5][0-9] | 
...
"TRUE_STATEMENT"            {return sym(sym.TS_WD, new String(yytext()));}
"FALSE_STATEMENT"            {return sym(sym.FS_WD, new String(yytext()));}
