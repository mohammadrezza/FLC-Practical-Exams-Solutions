...
public class sym {
  ...
  public static final int UPDATE_WD = 14;
  public static final int SPEED_WD = 13;
  public static final int HEIGHT_WD = 12;
  public static final int CM = 7;
  public static final int COND_WD = 16;
  public static final int EQ = 8;
  public static final int EOF = 0;
  public static final int SEP = 6;
  public static final int OB = 9;
  public static final int error = 1;
  public static final int INIT_WD = 11;
...
public String[] TT;
	public sym(){
		...
		TT[5]=new String("SC");
		TT[14]=new String("UPDATE_WD");
		TT[13]=new String("SPEED_WD");
		TT[12]=new String("HEIGHT_WD");
		TT[7]=new String("CM");
		TT[16]=new String("COND_WD");
		TT[8]=new String("EQ");
		TT[0]=new String("EOF");
		TT[6]=new String("SEP");
		TT[9]=new String("OB");
		TT[1]=new String("error");
		TT[11]=new String("INIT_WD");
