...
public class sym {
  /* terminals */
  public static final int UPDATE_WD = 15;
  public static final int CM = 7;
  public static final int DONE_WD = 16;
  ...
  public static final int SUM_WD = 18;
  ...
  public static final int MUL_WD = 19;
...
public String[] TT;
	public sym(){
		TT = new String[100];
		TT[15]=new String("UPDATE_WD");
		TT[7]=new String("CM");
		TT[16]=new String("DONE_WD");
